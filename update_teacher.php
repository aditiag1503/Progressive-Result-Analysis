...
<center>
<h3>Update Teacher's Details</h3>
...
{
?>
<option value="<?php echo  $i+4-2000; ?>"><?php echo $i;echo "-";echo $i+4; ?></option>
<?php } ?>
</select></td></tr>
...
<tr>
<td colspan="2"><input type="submit" value="proceed" onclick="return validate()" /></td></tr>
</form>
</table>
</center>
<?php
